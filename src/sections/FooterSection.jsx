      ...
      <div className="2xl:h-[110dvh] relative md:pt-[20vh] pt-[10vh]">
        ...
        {isMobile ? (
          ...
          <video
            ...
            playsInline
            muted
            className="absolute top-0 object-contain z-0 pointer-events-none mix-blend-lighten"
          />
        )}
          ...
          border at the bottom for a clean, modern look. */}
              <input
                ...
                className="w-full placeholder:font-sans placeholder:text-[#999999] 
                          ...
                          text-milk relative z-10"
              />
              <img
                src="/images/arrow.svg"
                alt="arrow"
                className="cursor-pointer relative z-10 ml-2 flex-shrink-0"
              />
            </div>
          </div>
        </div>
